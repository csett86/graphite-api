...
class glyphStandaloneFunctionTest(TestCase):
    ...
    def test_safeArgs_list_with_nan(self):
        self.assertEqual(list(glyph.safeArgs([1, 5.1, 6, float('Nan')])),
                         [1, 5.1, 6])
    ...
    def test_safeSum_list_with_nan(self):
        self.assertAlmostEqual(glyph.safeSum([1, 5.1, 6, float('Nan')]), 12.1,
                               places=4)
    ...
    def test_sort_stacked_stack_and_no_stack(self):
        ...
        seriesList[2].options = 'stacked'
        self.assertEqual(glyph.sort_stacked(copy.deepcopy(seriesList)),
                         [seriesList[0], seriesList[2], seriesList[1]])
...
class AxisTicsTest(TestCase):
    ...
    def test_AxisTics_chooseDelta_very_small(self):
        self.assertAlmostEqual(glyph._AxisTics.chooseDelta(1.0e-10),
                               1.0, places=4)
